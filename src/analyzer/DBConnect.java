...
public class DBConnect {
	static String Url = "jdbc:mysql://euve35520.vserver.de:3306/Valideon_test?useServerPrepStmts=false&rewriteBatchedStatements=true";
	static String user = "valideon_user";
	static String pass = "TPc2e3Xq86AzN2a2";
	static int interv;
	static String symb;
	static int i = 0;
